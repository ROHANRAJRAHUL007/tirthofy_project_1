...
class AllDayBreakfast extends StatefulWidget {
  const AllDayBreakfast({super.key});

  @override
  State<AllDayBreakfast> createState() => _AllDayBreakfastState();
}

class _AllDayBreakfastState extends State<AllDayBreakfast> {
  @override
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: alldayBreakfast.length,
                ...
                child: ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: FoodcontainerBase(
                      imagePath: alldayBreakfast[index],
                      foodName: alldayBreakfastName[index],
                    ),
                  ),
                ),
              );
